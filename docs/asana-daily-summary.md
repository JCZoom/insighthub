...
**Last synced:** 2026-04-18T22:28:40.705231
**Project GID:** 1214122597260827

## Overview
- **Tasks:** 176 (132 completed)
- **Milestones:** 0
- **Subtasks:** 476 (300 completed)
- **Sections:** 16
...
### 🔐 Auth & Security
8/9 tasks done | 0 milestones

- ⬜ **🔐 Metric-Level RBAC — Granular Financial Data Restrictions & Builder UX** [0/5 subtasks]
...
| Due | Task | Section |
|-----|------|---------|
| 2026-04-19 | 🔒 Verify & Enable EBS Volume Encryption on EC2 (CISO §6.1) | 🚀 Deployment & DevOps |
| 2026-04-19 | 🔒 URGENT: Verify & Enable EBS Volume Encryption | 🎯 Jeff — Action Needed |
