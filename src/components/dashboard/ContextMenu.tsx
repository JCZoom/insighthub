...
import {
  ...
  PlusCircle, BarChart3, Table2, Gauge, Type, Library, Settings2, LayoutDashboard,
} from 'lucide-react';
...
export function getWidgetActions(callbacks: {
  ...
  return [
    ...
    ...(callbacks.addToDashboard ? [{ label: 'Copy to Dashboard', icon: LayoutDashboard, onClick: callbacks.addToDashboard }] : []),
